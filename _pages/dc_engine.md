...
| | |
| :--- | :--- |
| <span class="pkg"><img src="/assets/img/icons/eye.png" width="48" height="48" /><span class="pkg-body">**protocol detection** <br> identifying network protocols, extracting fields, decoding values.</span></span> | <span class="pkg"><img src="/assets/img/icons/block.png" width="48" height="48" /><span class="pkg-body">**internet services classification** <br> classification of services and workflow definition (audio/video/file transfer).</span></span> |
| <span class="pkg"><img src="/assets/img/icons/integration.png" width="48" height="48" /><span class="pkg-body">**integration into other solutions** <br> ips/ids, siem, dlp, etc.</span></span> | <span class="pkg"><img src="/assets/img/icons/folder.png" width="48" height="48" /><span class="pkg-body">**network activity logging** <br> logging of network activity that can be used in the investigation of incidents.</span></span> |
| <span class="pkg"><img src="/assets/img/icons/ai.png" width="48" height="48" /><span class="pkg-body">**data collection for ai** <br> collecting an array of data for use in AI systems.</span></span> | <span class="pkg"><img src="/assets/img/icons/user.png" width="48" height="48" /><span class="pkg-body">**user control** <br> putting users under control (saving all or selected information for certain users).</span></span> |
| <span class="pkg"><img src="/assets/img/icons/billing.png" width="48" height="48" /><span class="pkg-body">**collecting information for billing** <br> accumulation of information on streams for use in billing.</span></span> | <span class="pkg"><img src="/assets/img/icons/fire.png" width="48" height="48" /><span class="pkg-body">**hotfix of new vulnerabilities** <br> prevention of exploitation of new vulnerabilities, before the release of official fixes.</span></span> |
...
| | |
| :--- | :--- |
| <span class="pkg"><img src="/assets/img/icons/update.png" width="48" height="48" /><span class="pkg-body">**service_update** <span class="tag-ready">[ready]</span> <br> Daily service classification configuration updates (data patterns, IPs, domains) <br> `> protocols:` no <br> `> extensions:` probe</span></span> | <span class="pkg"><img src="/assets/img/icons/workflow.png" width="48" height="48" /><span class="pkg-body">**workflow** <span class="tag-ready">[ready]</span> <br> Classification audio/video calls, chat, file transfer <br> `> protocols:` no <br> `> extensions:` rtc_media, spid</span></span> |
| <span class="pkg"><img src="/assets/img/icons/shield.png" width="48" height="48" /><span class="pkg-body">**security** <span class="tag-roadmap">[roadmap]</span> <br> ICMP/DNS tunnel detection, invalid certs, C&C server access, file extraction, leaks, DDoS <br> `> protocols:` no <br> `> extensions:` sec, filecarver, sensdata, ddos</span></span> | <span class="pkg"><img src="/assets/img/icons/network.png" width="48" height="48" /><span class="pkg-body">**network** <span class="tag-roadmap">[roadmap]</span> <br> QoS estimation, error detection (re-transmissions, inactive flows, ping unreachables) <br> `> protocols:` modbus, dnp3, profinet <br> `> extensions:` qos, netcon</span></span> |
| <span class="pkg"><img src="/assets/img/icons/industrial.png" width="48" height="48" /><span class="pkg-body">**industrial** <span class="tag-roadmap">[roadmap]</span> <br> The set of industrial protocols (detection, deep field dissection) <br> `> protocols:` todo <br> `> extensions:` no</span></span> | <span class="pkg"><img src="/assets/img/icons/log.png" width="48" height="48" /><span class="pkg-body">**dlog** <span class="tag-roadmap">[roadmap]</span> <br> IPDR transmission to remote service/server (NetFlow, HTTP, JSON formats) <br> `> protocols:` no <br> `> extensions:` dlog</span></span> |
